...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/docs/3.1.0-SNAPSHOT/maven-plugin/reference/htmlsingle/#aot)
...
```
$ docker run --rm ok:0.0.1-SNAPSHOT
```
